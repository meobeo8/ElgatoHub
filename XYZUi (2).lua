...
ImageButton.MouseButton1Down:connect(function()
    ...
    if ElgatoHub then
        ...
        Notify("UI Enabled: " .. tostring(ElgatoHub.Enabled), 0.7)
    else
...
Title.Text = "ELGATO HUB - XYZ UI | <font color='rgb(87, 85, 211)'>".. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name.. "</font>"
Title.RichText = true;
...
callback(state)
Notify(tostring(Name .. " : " .. tostring(default)), 0.5)
Tgo = state
end
return ToglFunc
end
