loadstring(game:HttpGet("https://raw.githubusercontent.com/TranVanBao1411/LoadScript/main/AntiKick"))()
...
Notify("Check your network if ui not working", 10)
...
for _, Interface in ipairs(game.CoreGui:GetChildren()) do
    if Interface.Name == "ElgatoHub" or Interface.Name == "TrueFalseUi" then
        Interface:Destroy()
    end
end

_G.Color = Color3.fromRGB(87, 85, 211)
_G.Color1 = Color3.fromRGB(255, 255, 255)
_G.Color2 = Color3.fromRGB(40,40,40)
  ...
  coroutine.resume(
      coroutine.create(
          function()
              ...
              Circle.Name = "Circle"
              Circle.BackgroundColor3 = _G.Color1
              Circle.Image = "rbxassetid://17254290146"
              Circle.BackgroundTransparency = 1.000
              Circle.ZIndex = 10
              Circle.ImageColor3 = _G.Color1
...
for _, v in ipairs(game.CoreGui:GetChildren()) do
    if v.Name == "ElgatoHub" or v.Name == "ELGATO HUB ON/OFF" then
        v:Destroy()
    end
end
...
ImageButton.MouseButton1Down:connect(function()
    local ElgatoHub = game.CoreGui:FindFirstChild("ElgatoHub")
    if ElgatoHub then
        ElgatoHub.Enabled = not ElgatoHub.Enabled
        Notify("UI Enabled: " .. tostring(ElgatoHub.Enabled), 0.2)
    else
      Notify("ElgatoHub GUI not found!")
    end
end)
...
TextLabel.Position = UDim2.new(0.120833337, 0, 0.0602890813, 0)  -- Vị trí bên trên button một chút
TextLabel.Size = UDim2.new(0, 200, 0, 20)
TextLabel.Font = Enum.Font.SourceSansBold
TextLabel.Text = "ELGATO"
TextLabel.TextColor3 = _G.Color1
...
Title.BackgroundColor3 = _G.Color1
Title.Position = UDim2.new(0.015, 0, 0.06, 0)
Title.Size = UDim2.new(0, 483, 0, 31)
Title.Font = _G.Text
Title.Text = "ELGATO HUB - TVB UI | ".. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
Title.RichText = true;
Title.TextColor3 = _G.Color1
Title.BackgroundTransparency = 1.000
Title.TextSize = 12.8
Title.TextWrapped = true
Title.TextXAlignment = Enum.TextXAlignment.Left

RainbowColor(Title_Rainbow, Title)

UICorner.CornerRadius = UDim.new(0, 5)
UICorner.Parent = Main
Top.Name = "Top"
Top.Parent = Main
Top.BackgroundColor3 = _G.Color1
...
ClickFrame.BackgroundColor3 = _G.Color1
...
TabContainer.BackgroundColor3 = _G.Color1
...
Menu_Setting.ImageColor3 = _G.Color1
...
Settings.ImageColor3 = _G.Color1
Settings.ZIndex = 10
...
RainbowColor(postog123_1, postog123)
...
Line.BackgroundColor3 = _G.Color1
...
ImageLabel.BackgroundColor3 = _G.Color1
...
Name.Active = true
Name.BackgroundColor3 = _G.Color1
Name.BackgroundTransparency = 1.000
Name.Position = UDim2.new(0.28, 0, 0.04, 0)
Name.Size = UDim2.new(0, 150, 0, 27)
Name.Font = _G.Text
Name.TextColor3 = _G.Color1
Name.TextSize = 8.500
Name.Text = plr.Name.. " ("..plr.DisplayName..")"
Name.TextXAlignment = Enum.TextXAlignment.Left

RainbowColor(Name_1, Name)
  ...
  while wait(0.001) do
    pcall(function()
      game:GetService("TweenService"):Create(
        ...
        {
          Size = UDim2.new(plr.Character.Humanoid.Health/plr.Character.Humanoid.MaxHealth, 0, 0, 5)
        }
      ):Play()
...
spawn(function()
    ...
    while wait() do
        pcall(function()
            ...
            Lvl.Text = "Real Time:" .. os.date(" %H:%M:%S - %d/%m/") .. os.date("%Y")
        end)
        wait(0.001)
    end
end)
...
spawn(function()
    ...
    while wait() do
        pcall(function()
            ...
            Fruit.Text = "Client Time: ".. hours.. ":".. minutes.. ":".. seconds .. " - Players: " .. playerCount
        end)
        wait(0.001)
    end
end)
...
Settings.MouseButton1Click:Connect(function()
  ...
  RainbowColor(SettingStroke_1, SettingStroke)
...
StaminaText.Active = true
StaminaText.BackgroundColor3 = _G.Color1
StaminaText.BackgroundTransparency = 1.000
StaminaText.Position = UDim2.new(0.0260000005, 0, 0.04, 0)
StaminaText.Size = UDim2.new(0, 200, 0, 22)
StaminaText.Font = _G.Text
StaminaText.Text = "Misc Functions"
StaminaText.TextColor3 = _G.Color1
StaminaText.TextSize = 14.500
StaminaText.TextWrapped = true
StaminaText.TextXAlignment = Enum.TextXAlignment.Center

RainbowColor(StaminaText_1, StaminaText)
...
Text2.BackgroundColor3 = _G.Color1
...
Textbtn2.Font = _G.Text
Textbtn2.Text = ""
Textbtn2.TextColor3 = _G.Color1
...
Textlavel3.BackgroundColor3 = _G.Color1
...
Textlavel3.Font = _G.Text
Textlavel3.Text = "BOOST FPS"
Textlavel3.TextColor3 = _G.Color1
...
Texbob3.Font = _G.Text
Texbob3.Text = ""
Texbob3.TextColor3 = _G.Color1
...
Textlval3.BackgroundColor3 = _G.Color1
Textlval3.BackgroundTransparency = 1.000
Textlval3.Position = UDim2.new(0.5, 0, 0.5, 0)
Textlval3.Size = UDim2.new(0, 40, 0, 12)
Textlval3.ZIndex = 16
Textlval3.Font = _G.Text
Textlval3.Text = "INFNITE YEILD"
Textlval3.TextColor3 = _G.Color1
...
Texbslb4.Font = _G.Text
Texbslb4.Text = ""
Texbslb4.TextColor3 = _G.Color1
...
Textlval4.BackgroundColor3 = _G.Color1
Textlval4.BackgroundTransparency = 1.000
Textlval4.Position = UDim2.new(0.5, 0, 0.5, 0)
Textlval4.Size = UDim2.new(0, 40, 0, 12)
Textlval4.ZIndex = 16
Textlval4.Font = _G.Text
Textlval4.Text = "DELETE CONFIG"
Textlval4.TextColor3 = _G.Color1
...
Texbslb5.Font = _G.Text
Texbslb5.Text = ""
Texbslb5.TextColor3 = _G.Color1
...
Texbslb5.MouseButton1Click:Connect(function()
    ...
    Notify("Successfully deleted.", 10)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/TranVanBao1411/ElgatoHub/main/DeleteConfig.lua"))()
end)
...
Texbslb6.Font = _G.Text
Texbslb6.Text = ""
Texbslb6.TextColor3 = _G.Color1
...
Tab.BackgroundColor3 = _G.Color1
Tab.Size = UDim2.new(0, 87, 0, 30)  -- Adjust the '80' to your desired width
Tab.Text = ""
UICorner_3.CornerRadius = UDim.new(0, 3)
...
ImageLabel1.BackgroundColor3 = _G.Color1
...
TextLabel.BackgroundColor3 = _G.Color1
TextLabel.BackgroundTransparency = 1.000
TextLabel.Position = UDim2.new(0.34, 0, 0.100000001, 0)
...
Page.Name = "Page"
Page.Parent = Bottom
Page.BackgroundColor3 = _G.Color1
...
Left.Parent = Page
Left.Active = true
Left.BackgroundColor3 = _G.Color1
...
Right.Parent = Page
Right.Active = true
Right.BackgroundColor3 = _G.Color1
...
ImageLabel.ImageColor3 = _G.Color1
...
Top_2.BackgroundColor3 = _G.Color1
...
SectionContainer.BackgroundColor3 = _G.Color1
...
SectionContainer_2.BackgroundColor3 = _G.Color1
...
Label.BackgroundColor3 = _G.Color1
...
Label22.BackgroundColor3 = _G.Color1
...
Label23.BackgroundColor3 = _G.Color1
Label23.Position = UDim2.new(0,180,0.5,0)
Label23.Size = UDim2.new(0, 30, 0, 2)

RainbowColor(Label22_1, Label22)
RainbowColor(Label23_1, Label23)
...
Text.Parent = Label
Text.AnchorPoint = Vector2.new(0.5, 0.5)
Text.BackgroundColor3 = _G.Color1
Text.BackgroundTransparency = 1.000
Text.Position = UDim2.new(0.5, 0, 0.5, 0)
...
TextButton_4.Font = _G.Text
TextButton_4.Text = ""
TextButton_4.TextColor3 = _G.Color1
...
TextLabel_3.BackgroundColor3 = _G.Color1
TextLabel_3.BackgroundTransparency = 1.000
TextLabel_3.Position = UDim2.new(0.5, 0, 0.5, 0)
TextLabel_3.Size = UDim2.new(0, 40, 0, 12)
TextLabel_3.ZIndex = 16
TextLabel_3.Font = _G.Text
TextLabel_3.Text = Name
TextLabel_3.TextColor3 = _G.Color1
...
TextButton.Font = _G.Text
TextButton.Text = ""
TextButton.TextColor3 = _G.Color1
...
MainToggle_3.ImageColor3 = _G.Color1
MainToggle_3.Visible = false
RainbowColor(MainToggle_3_1, MainToggle_3)
UICorner_3.CornerRadius = UDim.new(0, 3)
...
callback(state)
Notify(tostring(Name .. " : " .. tostring(Tgo)), 0.5)
Tgo = state
end
return ToglFunc
end
...
Text_5.BackgroundColor3 = _G.Color1
...
HeadTitle.ZIndex = 16
HeadTitle.Font = _G.Text
HeadTitle.PlaceholderColor3 = _G.Color1
HeadTitle.PlaceholderText = ""
HeadTitle.Text = ""
HeadTitle.TextColor3 = _G.Color1
...
HeadTitle.FocusLost:Connect(
  function(ep)
  if ep then
    Notify(tostring(Name .. " : " .. tostring(HeadTitle.Text)), 0.5)
...
DropTitle.BackgroundColor3 = _G.Color1
DropTitle.BackgroundTransparency = 1.000
DropTitle.Size = UDim2.new(0, 240, 0, 31)
DropTitle.Font = _G.Text
DropTitle.Text = getpro()
DropTitle.TextColor3 = _G.Color1
DropTitle.TextSize = 12.000
DropTitle.TextXAlignment = Enum.TextXAlignment.Left

RainbowColor(DropTitle_1, DropTitle)
...
Item.MouseButton1Click:Connect(function()
  ...
  Notify(tostring(Name .. " : " .. tostring(Item.Text)), 0.5)
  end)
end
...
Text_2.BackgroundColor3 = _G.Color1
...
Scroll_Items.BackgroundColor3 = _G.Color1
...
CustomValue.Font = _G.Text
CustomValue.Text = "50"
CustomValue.TextColor3 = _G.Color1
...
MainValue.BackgroundColor3 = _G.Color1
MainValue.Size = UDim2.new((de or 0) / max, 0, 0, 5)
MainValue.BorderSizePixel = 0

RainbowColor(MainValue_1, MainValue)
